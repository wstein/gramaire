...
//      writes that grammar's generated `codegen-scratch/src/main/scala/gramark/scratch/
...
function runGrammar(grammarKey, scratchSrcDir, vectorsPath) {
  const out = execFileSync(
    ...
    [
      "-batch",
      `cli/runMain gramark.cli.ScalaPegParityMain ${scratchSrcDir} ${vectorsPath} ${grammarKey}`,
