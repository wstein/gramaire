#!/usr/bin/env node
// Precomputes the homepage's embedded Grimoire Notebook preview: a real LabResponse for the
...
// index.astro's frontmatter as GrimoireNotebookIsland's `initial` prop.
//
...
const source = readFileSync(
  path.join(repoRoot, "examples/calc-js.grmk.md"),
  "utf8",
);
...
const responseJson = gramarkLabEvaluate(
