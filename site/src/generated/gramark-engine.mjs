...
var $$unescape = /* @__PURE__ */ (function() {
  var go = function(cs) {
    ...
    if (v instanceof Just && v.value0.head === "\\") {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Lr (line 81, column 34 - line 83, column 26): " + [v1.constructor.name]);
    }
    ;
    if (v instanceof Just) {
    ...
    return function(ntId) {
      return function(table) {
        var onOf = function(v) {
          ...
          ;
          throw new Error("Failed pattern match at Gramark.IR (line 465, column 10 - line 468, column 35): " + [v.constructor.name]);
        };
        ...
        var actOf = function(v) {
          ...
          ;
          throw new Error("Failed pattern match at Gramark.IR (line 471, column 11 - line 474, column 24): " + [v.constructor.name]);
        };
...
var algorithmName = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.IR (line 420, column 17 - line 423, column 18): " + [v.constructor.name]);
};
      ...
      return function(v) {
        ...
        var termLiteralMap = (function() {
          var perSym = function(m) {
            return function(v12) {
              ...
              ;
              throw new Error("Failed pattern match at Gramark.IR (line 334, column 16 - line 344, column 36): " + [v12.constructor.name]);
            };
          };
        ...
        var irPrecedence = (function() {
          ...
          var assocStr = function(a) {
            ...
            ;
            throw new Error("Failed pattern match at Gramark.IR (line 373, column 18 - line 376, column 25): " + [a.constructor.name]);
          };
        ...
        var irRules = (function() {
          var withField = function(f) {
            return function(v12) {
              ...
              ;
              throw new Error("Failed pattern match at Gramark.IR (line 410, column 19 - line 412, column 31): " + [v12.constructor.name]);
            };
          };
          var toRef = function(v12) {
            ...
            ;
            throw new Error("Failed pattern match at Gramark.IR (line 398, column 13 - line 408, column 47): " + [v12.constructor.name]);
          };
            ...
            return function(v12) {
              return {
                ...
                actions: (function() {
                  ...
                  ;
                  throw new Error("Failed pattern match at Gramark.IR (line 394, column 18 - line 396, column 24): " + [v12.value1.value2.constructor.name]);
                })()
              };
            };
          };
        ...
        ;
        throw new Error("Failed pattern match at Gramark.IR (line 288, column 3 - line 307, column 10): " + [v1.constructor.name]);
      };
    };
  };
};
...
var renderTree = function(prods) {
  var label = function(v) {
    if (v instanceof Branch) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 168, column 19 - line 170, column 27): " + [v1.constructor.name]);
    }
    ;
    if (v instanceof Token) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Playground (line 167, column 11 - line 171, column 36): " + [v.constructor.name]);
  };
  ...
  var go = function(depth) {
    return function(node) {
      return indent(depth) + (label(node) + (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 164, column 10 - line 166, column 24): " + [node.constructor.name]);
      })());
    };
  };
  return go(0);
...
var renderTrace = function(prods) {
  return function(cst) {
    var symText = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 189, column 13 - line 192, column 15): " + [v.constructor.name]);
    };
    var prodLabel = function(p) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 184, column 17 - line 188, column 26): " + [v.constructor.name]);
    };
    var steps = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 181, column 11 - line 183, column 80): " + [v.constructor.name]);
    };
...
var metaJsonOf = function(grammar) {
  var refField = function(v2) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Playground (line 150, column 14 - line 152, column 20): " + [v2.constructor.name]);
  };
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Playground (line 140, column 22 - line 142, column 65): " + [v.constructor.name]);
};
  ...
  if (v1 instanceof Right) {
    ...
    var defs = (function() {
      ...
      if (v22 instanceof Just) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 72, column 23 - line 74, column 23): " + [v3.constructor.name]);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 71, column 14 - line 75, column 22): " + [v22.constructor.name]);
    })();
    ...
    if (v2 instanceof Right) {
      ...
      var trace = (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 108, column 21 - line 110, column 28): " + [v3.constructor.name]);
      })();
      var tree = (function() {
        var v3 = head(csts);
        if (v3 instanceof Just) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 103, column 20 - line 107, column 28): " + [v3.constructor.name]);
      })();
      var cstJson = (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 111, column 23 - line 113, column 28): " + [v3.constructor.name]);
      })();
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Playground (line 81, column 7 - line 130, column 14): " + [v2.constructor.name]);
  }
  ;
  throw new Error("Failed pattern match at Gramark.Playground (line 49, column 30 - line 130, column 14): " + [v1.constructor.name]);
};
export {
  evaluate
};
