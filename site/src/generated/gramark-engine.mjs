...
var withActionLang = function(v) {
  return function(v1) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.IR (line 702, column 1 - line 702, column 43): " + [v.constructor.name, v1.constructor.name]);
  };
};
var irVersion = 0;
var effectiveFields = function(g) {
  return function(rule) {
    var termId = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.IR (line 740, column 12 - line 742, column 21): " + [v.constructor.name]);
    };
    var refField = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.IR (line 730, column 14 - line 732, column 20): " + [v.constructor.name]);
    };
    ...
    var autoBase = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.IR (line 734, column 14 - line 738, column 19): " + [v.constructor.name]);
    };
    ...
    var resolve2 = function(ref) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.IR (line 724, column 17 - line 728, column 19): " + [v.constructor.name]);
    };
    ...
    return function(ntId) {
      return function(table) {
        var onOf = function(v) {
          ...
          ;
          throw new Error("Failed pattern match at Gramark.IR (line 468, column 10 - line 471, column 35): " + [v.constructor.name]);
        };
        ...
        var actOf = function(v) {
          ...
          ;
          throw new Error("Failed pattern match at Gramark.IR (line 474, column 11 - line 477, column 24): " + [v.constructor.name]);
        };
...
var algorithmName = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.IR (line 423, column 17 - line 426, column 18): " + [v.constructor.name]);
};
      ...
      return function(v) {
        ...
        var termLiteralMap = (function() {
          var perSym = function(m) {
            return function(v12) {
              ...
              ;
              throw new Error("Failed pattern match at Gramark.IR (line 337, column 16 - line 347, column 36): " + [v12.constructor.name]);
            };
          };
        ...
        var irPrecedence = (function() {
          ...
          var assocStr = function(a) {
            ...
            ;
            throw new Error("Failed pattern match at Gramark.IR (line 376, column 18 - line 379, column 25): " + [a.constructor.name]);
          };
        ...
        var irRules = (function() {
          var withField = function(f) {
            return function(v12) {
              ...
              ;
              throw new Error("Failed pattern match at Gramark.IR (line 413, column 19 - line 415, column 31): " + [v12.constructor.name]);
            };
          };
          var toRef = function(v12) {
            ...
            ;
            throw new Error("Failed pattern match at Gramark.IR (line 401, column 13 - line 411, column 47): " + [v12.constructor.name]);
          };
            ...
            return function(v12) {
              return {
                ...
                actions: (function() {
                  ...
                  ;
                  throw new Error("Failed pattern match at Gramark.IR (line 397, column 18 - line 399, column 24): " + [v12.value1.value2.constructor.name]);
                })()
              };
            };
          };
        ...
        ;
        throw new Error("Failed pattern match at Gramark.IR (line 291, column 3 - line 310, column 10): " + [v1.constructor.name]);
      };
    };
  };
};
...
var unwrapBinder = function(code) {
  ...
  if (v instanceof Just) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Backend.Js (line 91, column 13 - line 93, column 25): " + [v1.constructor.name]);
  }
  ;
  throw new Error("Failed pattern match at Gramark.Backend.Js (line 89, column 21 - line 93, column 25): " + [v.constructor.name]);
};
var runtime = /* @__PURE__ */ joinWith("\n")(["// A namedtuple: the child values as a real Array (index / spread / map all", "// work) with each named position also reachable by its field name.", "function tuple(values, names) {", "  const t = values.slice();", "  names.forEach((n, i) => { if (n != null) t[n] = values[i]; });", "  return t;", "}", "", "function fold(node) {", "  if (node.token !== undefined) return node.text;", "  const kids = node.children.map(fold);", "  const action = actions[node.rule];", "  if (action) return action(tuple(kids, fields[node.rule]));", "  return kids.length === 1 ? kids[0] : kids;", "}", "", "// Evaluate a gramark-cst tree to a value using the baked inline actions.", "export function evaluate(cst) {", "  return fold(cst);", "}"]);
...
var maybeStr = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Backend.Js (line 78, column 12 - line 80, column 20): " + [v.constructor.name]);
};
...
var renderTree = function(prods) {
  var label = function(v) {
    if (v instanceof Branch) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 223, column 19 - line 225, column 27): " + [v1.constructor.name]);
    }
    ;
    if (v instanceof Token) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Playground (line 222, column 11 - line 226, column 36): " + [v.constructor.name]);
  };
  ...
  var go = function(depth) {
    return function(node) {
      return indent(depth) + (label(node) + (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 219, column 10 - line 221, column 24): " + [node.constructor.name]);
      })());
    };
  };
  return go(0);
...
var renderTrace = function(prods) {
  return function(cst) {
    var symText = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 244, column 13 - line 247, column 15): " + [v.constructor.name]);
    };
    var prodLabel = function(p) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 239, column 17 - line 243, column 26): " + [v.constructor.name]);
    };
    var steps = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 236, column 11 - line 238, column 80): " + [v.constructor.name]);
    };
...
var methodName = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Playground (line 63, column 14 - line 66, column 17): " + [v.constructor.name]);
};
var metaJsonOf = function(grammar) {
  var refField = function(v2) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Playground (line 205, column 14 - line 207, column 20): " + [v2.constructor.name]);
  };
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Playground (line 195, column 22 - line 197, column 65): " + [v.constructor.name]);
};
var evalJsOf = function(source) {
  return function(grammar) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Playground (line 186, column 27 - line 188, column 64): " + [v.constructor.name]);
  };
};
  ...
  if (v1 instanceof Right) {
    ...
    var defs = (function() {
      ...
      if (v22 instanceof Just) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 102, column 27 - line 104, column 27): " + [v3.constructor.name]);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 101, column 18 - line 105, column 26): " + [v22.constructor.name]);
    })();
    ...
    if (v2 instanceof Right) {
      ...
      var trace = (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 149, column 25 - line 151, column 32): " + [v3.constructor.name]);
      })();
      var tree = (function() {
        var v3 = head(csts);
        if (v3 instanceof Just) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 144, column 24 - line 148, column 32): " + [v3.constructor.name]);
      })();
      var cstJson = (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 153, column 27 - line 155, column 32): " + [v3.constructor.name]);
      })();
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Playground (line 115, column 11 - line 176, column 18): " + [v2.constructor.name]);
  }
  ;
  throw new Error("Failed pattern match at Gramark.Playground (line 73, column 5 - line 176, column 18): " + [v1.constructor.name]);
};
export {
  evaluate
};
