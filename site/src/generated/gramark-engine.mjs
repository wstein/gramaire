...
var normalizeAction = function(syms) {
  return function(body) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Desugar (line 205, column 29 - line 207, column 71): " + [v.constructor.name]);
  };
};
...
var deepRefs = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Desugar (line 321, column 12 - line 328, column 48): " + [v.constructor.name]);
};
    ...
    return function(usingAction) {
      var step = function(v2) {
        return function(v1) {
          ...
          if (v2 instanceof Right) {
            ...
            if (v1 instanceof Ref) {
              ...
              if ($103 instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at Gramark.Desugar (line 284, column 62 - line 296, column 14): " + [$103.value0.value2.constructor.name]);
              }
              ;
              return v22(true);
            }
          ...
          ;
          throw new Error("Failed pattern match at Gramark.Desugar (line 282, column 3 - line 282, column 27): " + [v2.constructor.name, v1.constructor.name]);
        };
      };
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Desugar (line 275, column 3 - line 280, column 8): " + [v.constructor.name]);
    };
  };
};
var expandAlt = function(im) {
  return function(v) {
    ...
    if (otherwise) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Desugar (line 250, column 17 - line 254, column 57): " + [v.value2.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Gramark.Desugar (line 247, column 1 - line 247, column 56): " + [im.constructor.name, v.constructor.name]);
  };
};
...
var inlineExpand = function(v) {
  ...
  var addInline = function(acc) {
    return function(v1) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Desugar (line 231, column 3 - line 239, column 22): " + [acc.constructor.name, v1.constructor.name]);
    };
  };
  return bind2(foldl4(addInline)(new Right(empty2))(v))(function(inlineMap) {
    return bind2(traverse2(expandRule(inlineMap))(filter(function($249) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Desugar (line 225, column 3 - line 227, column 40): " + [v1.constructor.name]);
    });
  });
};
var bools = function(n) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Desugar (line 186, column 1 - line 186, column 38): " + [n.constructor.name]);
};
var baseName = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Desugar (line 192, column 12 - line 199, column 26): " + [v.constructor.name]);
};
      ...
      var step = function(acc) {
        return function(sym2) {
          if (optStar(sym2)) {
            ...
            ;
            throw new Error("Failed pattern match at Gramark.Desugar (line 98, column 23 - line 100, column 72): " + [v1.constructor.name]);
          }
          ;
          if (otherwise) {
            return {
          ...
          ;
          throw new Error("Failed pattern match at Gramark.Desugar (line 97, column 5 - line 101, column 70): " + [acc.constructor.name, sym2.constructor.name]);
        };
      };
      return foldl4(step)({
        out: [],
          ...
          if (existing instanceof Shift && look instanceof Term) {
            return bind3(lookup3(look.value0)(ctx.prec.terms))(function(tp) {
              return bind3(prodPrecedence(ctx)(prodIdx))(function(pp) {
                ...
                ;
                throw new Error("Failed pattern match at Gramark.Table (line 447, column 10 - line 450, column 22): " + [pp.assoc.constructor.name]);
              });
            });
          }
          ;
...
var firstOfSymbol = function(firsts) {
  return function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Table (line 198, column 24 - line 201, column 30): " + [v.constructor.name]);
  };
};
var firstSeqThen = function(ctx) {
  return function(beta) {
    return function(a) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Table (line 291, column 27 - line 293, column 29): " + [v.constructor.name]);
    };
  };
};
var eqSymbol = {
  ...
  return function(m0) {
    var addProd = function(m) {
      return function(v) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Table (line 206, column 28 - line 208, column 65): " + [v1.constructor.name]);
      };
    };
              ...
              return function(m) {
                return function(sym2) {
                  if (sym2 instanceof NonTerm) {
                    ...
                    ;
                    throw new Error("Failed pattern match at Gramark.Table (line 226, column 18 - line 229, column 60): " + [v.constructor.name]);
                  }
                  ;
                  return m;
                };
      ...
      return function(part) {
          ...
          var step = function(c) {
            return function(acc) {
              return function(sig) {
                ...
                ;
                throw new Error("Failed pattern match at Gramark.Table (line 581, column 22 - line 583, column 98): " + [v.constructor.name]);
              };
            };
          };
        ...
        var succBlk = function(c) {
          return function(x) {
            ...
            ;
            throw new Error("Failed pattern match at Gramark.Table (line 568, column 17 - line 570, column 18): " + [v.constructor.name]);
          };
        };
    ...
    return function(realProds) {
      ...
      var addTrans = function(acc) {
        return function(v) {
          ...
          ;
          throw new Error("Failed pattern match at Gramark.Table (line 697, column 42 - line 700, column 15): " + [v.value0.value1.constructor.name]);
        };
      };
    ...
    return function(realProds) {
        ...
        return function(sym2) {
          return function(existing) {
            return function(newProd) {
              ...
              ;
              throw new Error("Failed pattern match at Gramark.Table (line 430, column 43 - line 433, column 79): " + [existing.constructor.name]);
            };
          };
        };
      };
      var addTrans = function(acc) {
        return function(v) {
          ...
          ;
          throw new Error("Failed pattern match at Gramark.Table (line 398, column 42 - line 401, column 15): " + [v.value0.value1.constructor.name]);
        };
      };
        ...
        return function(acc) {
          return function(it) {
            ...
            if (v instanceof Just) {
              ...
              ;
              throw new Error("Failed pattern match at Gramark.Table (line 420, column 18 - line 424, column 110): " + [v1.constructor.name]);
            }
            ;
            throw new Error("Failed pattern match at Gramark.Table (line 416, column 9 - line 424, column 110): " + [v.constructor.name]);
          };
        };
      };
      var addReduces = function(i) {
  ...
  var assign = function(i) {
    return function(acc) {
      return function(items) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Table (line 541, column 24 - line 543, column 107): " + [v.constructor.name]);
      };
    };
  };
  ...
  var assign = function(i) {
    return function(acc) {
      return function(items) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Table (line 494, column 24 - line 503, column 8): " + [v.constructor.name]);
      };
    };
  };
...
var buildStates = function(ctx) {
  ...
  var addState = function(st) {
    return function(items) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Table (line 365, column 23 - line 371, column 98): " + [v.constructor.name]);
    };
  };
  ...
  var process = function($copy_st) {
    return function($copy_i) {
      ...
      function $tco_loop(st, i) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Table (line 348, column 10 - line 350, column 93): " + [v.constructor.name]);
      }
      ;
      while (!$tco_done) {
...
var buildGlrTablesFor = function(method) {
  return function(g) {
    ...
    var states = (function() {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Table (line 679, column 12 - line 682, column 36): " + [method.constructor.name]);
    })();
  ...
  return function(method) {
    return function(g) {
      ...
      var states = (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Table (line 648, column 12 - line 651, column 36): " + [method.constructor.name]);
      })();
...
var sym = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Diagnostics (line 121, column 7 - line 124, column 13): " + [v.constructor.name]);
};
var refsOf = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Diagnostics (line 52, column 10 - line 59, column 46): " + [v.constructor.name]);
};
var prodName = function(prods) {
  return function(i) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Diagnostics (line 113, column 20 - line 116, column 45): " + [v.constructor.name]);
  };
};
var renderConflict = function(prods) {
  return function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Diagnostics (line 82, column 24 - line 108, column 67): " + [v.constructor.name]);
  };
};
...
var $$unescape = /* @__PURE__ */ (function() {
  var go = function(cs) {
    ...
    if (v instanceof Just && v.value0.head === "\\") {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Lr (line 80, column 34 - line 82, column 26): " + [v1.constructor.name]);
    }
    ;
    if (v instanceof Just) {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Lr (line 78, column 11 - line 83, column 53): " + [v.constructor.name]);
  };
  return function($218) {
...
var isUpperName = function(name) {
  ...
  return !contains(" ")(name) && (all3(classChar2)(toCharArray(name)) && (function() {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Lr (line 289, column 8 - line 291, column 23): " + [v.constructor.name]);
  })());
};
var isTokenDef = function(l) {
  return notEq13(charAt2(0)(l))(new Just(" ")) && (notEq13(charAt2(0)(l))(new Just("	")) && (function() {
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Lr (line 281, column 8 - line 283, column 46): " + [v.constructor.name]);
  })());
};
...
var gramarkBlocks = function(md) {
  var step = function(acc) {
    return function(line) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Lr (line 146, column 10 - line 148, column 21): " + [v.constructor.name]);
    };
  };
  return foldl7(step)({
    inside: false,
...
var precedenceOf = function(md) {
  ...
  ;
  throw new Error("Failed pattern match at Gramark.Lr (line 354, column 19 - line 356, column 23): " + [v.constructor.name]);
};
...
var parseWith = function(method) {
  return function(md) {
    ...
    if (v instanceof Right) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Lr (line 340, column 22 - line 343, column 56): " + [v1.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Gramark.Lr (line 338, column 10 - line 343, column 56): " + [v.constructor.name]);
  };
};
...
var renderTree = function(prods) {
  var label = function(v) {
    if (v instanceof Branch) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 131, column 19 - line 133, column 27): " + [v1.constructor.name]);
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Playground (line 130, column 11 - line 134, column 36): " + [v.constructor.name]);
  };
  ...
  var go = function(depth) {
    return function(node) {
      return indent(depth) + (label(node) + (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 127, column 10 - line 129, column 24): " + [node.constructor.name]);
      })());
    };
  };
  return go(0);
...
var renderTrace = function(prods) {
  return function(cst) {
    var symText = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 152, column 13 - line 155, column 15): " + [v.constructor.name]);
    };
    var prodLabel = function(p) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 147, column 17 - line 151, column 26): " + [v.constructor.name]);
    };
    var steps = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 144, column 11 - line 146, column 80): " + [v.constructor.name]);
    };
  ...
  if (v1 instanceof Right) {
    ...
    var defs = (function() {
      ...
      if (v22 instanceof Just) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 64, column 23 - line 66, column 23): " + [v3.constructor.name]);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Gramark.Playground (line 63, column 14 - line 67, column 22): " + [v22.constructor.name]);
    })();
    ...
    if (v2 instanceof Right) {
      ...
      var trace = (function() {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 95, column 21 - line 97, column 28): " + [v3.constructor.name]);
      })();
      var tree = (function() {
        var v3 = head(csts);
        if (v3 instanceof Just) {
        ...
        ;
        throw new Error("Failed pattern match at Gramark.Playground (line 90, column 20 - line 94, column 28): " + [v3.constructor.name]);
      })();
    ...
    ;
    throw new Error("Failed pattern match at Gramark.Playground (line 70, column 7 - line 112, column 14): " + [v2.constructor.name]);
  }
  ;
  throw new Error("Failed pattern match at Gramark.Playground (line 43, column 30 - line 112, column 14): " + [v1.constructor.name]);
};
export {
  evaluate
};
