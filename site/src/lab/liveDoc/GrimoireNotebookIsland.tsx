...
// comment on why) targets .grimoire__paper's clean layout, not the interactive Notebook/Source
...
function PaperBlock({
  ...
  return (
    <div class="grimoire__paper-source">
      <div class="grimoire__paper-source-label">{cellLabel(block)}</div>
      <pre>{block.text}</pre>
    </div>
  );
}
