...
// (58px) are sized for up to 3-digit line numbers — comfortable for any realistic .grmk.md file,
...
// (`NotebookTopbarTools`, `GrimoireNotebookIsland.tsx`). Reads/writes the exact same module-scope
