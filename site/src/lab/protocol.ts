...
/**
 * One ```gramark fence's role and 1-based, inclusive line span in LabRequest.source's own raw text — the opening ```gramark marker line through the closing ``` marker line.
 */
