...
export const glossary: Record<string, string> = {
  ...
  nonterminal:
    "A named grammar rule (mixed-case in Gramark), defined by its productions. Contrast a terminal.",
  terminal:
  ...
  lr1: "Left-to-right input, rightmost derivation, one token of lookahead — the parser class Gramark targets.",
  ...
  "epsilon-free":
    "A grammar with no empty (nullable) productions. Gramark's desugaring keeps the generated core epsilon-free.",
};
