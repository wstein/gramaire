...
-- | `/regex/` in the regular sublanguage (`Gramark.Regex`), and `modifiers` are
...
import Gramark.Regex (Rx, parseRegex)
...
parseTokens content =
  ...
  where
  meaningful line = line /= "" && line /= "gramark tokens"
