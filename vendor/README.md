...
not a build dependency: Gramark reads its `src/grammars/ANTLRv4{Lexer,Parser}.g4`
...
derived from those sources (e.g. [`examples/antlr/antlr4.grmk.md`](../examples/antlr/antlr4.grmk.md),
the hand conversion of the meta-grammar to Gramark) retains the copyright notice
