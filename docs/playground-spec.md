...
**Implementation status (v1 engine slice — done):** `lab/src/main/scala/gramark/lab/LabProtocol.scala`
...
in `lab/.jvm/src/test/scala/gramark/lab/LabApiSuite.scala` (accept/reject/
...
convention (reads `examples/calc.grmk.md`). **Not yet done:** the
