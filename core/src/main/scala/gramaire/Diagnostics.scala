...
// Ported from src/Gramaire/Diagnostics.purs.
object Diagnostics:
  ...
  private[gramaire] def levenshtein(a: String, b: String): Int =
  ...
  private[gramaire] def nearestMatch(bad: String, candidates: Vector[String]): Option[String] =
