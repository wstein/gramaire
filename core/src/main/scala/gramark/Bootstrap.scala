...
// the corresponding rule of `lr.grmk.md` — still PureScript-lambda syntax
// at this point in the port (`Gramark.Codegen`/the self-hosting proof
...
// `lr.grmk.md`'s embedded actions to Scala syntax together, once
