...
class BackendGoldenSuite extends munit.FunSuite:
  ...
  test("atn-ts: examples/calc.grmk.md under --strategy ll-star matches the committed golden") {
    val md = readFile("examples/calc.grmk.md")
    Lr.parse(md) match
      case Left(e) => fail(s"could not parse examples/calc.grmk.md: $e")
      case Right(g) =>
  ...
  test("scala-peg: examples/calc.grmk.md under --strategy ll-star matches the committed golden") {
    val md = readFile("examples/calc.grmk.md")
    Lr.parse(md) match
      case Left(e) => fail(s"could not parse examples/calc.grmk.md: $e")
      case Right(g) =>
  ...
  test(
    "scala-peg-fastparse: examples/calc.grmk.md under --strategy ll-star matches the committed golden"
  ) {
    val md = readFile("examples/calc.grmk.md")
    Lr.parse(md) match
      case Left(e) => fail(s"could not parse examples/calc.grmk.md: $e")
  ...
  test(
    "scala-peg-combinators: examples/calc.grmk.md under --strategy ll-star matches the committed golden"
  ) {
    val md = readFile("examples/calc.grmk.md")
    Lr.parse(md) match
      case Left(e) => fail(s"could not parse examples/calc.grmk.md: $e")
